---
title: Interactive Bike Rental Map
summary: Development of a "Single Page Application" simulating bicycle reservations in the city of Amiens based on the JCDecaux real-time API. This application is built in JavaScript, structured around Object-Oriented Programming, JQuery (slideshow), and the Bootstrap framework. It utilizes multiple APIs to offer interactive and immersive functionalities.

tags:
    - JavaScript / POO
    - JQuery
    - API JCDECAUX
    - APIs Leaflet, canva, Webstorage
    - Bootstrap
startDate: 2019-03-07
endDate: 2019-04-09
author: Valérie Lavoisier
url: https://applivelo-valerielavoisier.fr
